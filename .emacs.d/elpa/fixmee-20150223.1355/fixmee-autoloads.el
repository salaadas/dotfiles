...

;;;### (autoloads nil "fixmee" "fixmee.el" (0 0 0 0))
...
If called interactively, enable Fixmee mode if ARG is positive,
...
(put 'global-fixmee-mode 'globalized-minor-mode t)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "fixmee" '("fixmee-" "global-fixmee-mode")))
