...
If called interactively, enable Back-Button mode if ARG is
...
`mark-ring' in a different state." t nil)
...
This command is much like the reverse of `pop-global-mark'." t nil)
